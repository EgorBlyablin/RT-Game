...
// не стал в методе делать смену переменных активности на false и true, потому что они
// статические => не наследуются => так как метод не знает, какой экран мы вырубаем, то он и не сможет выключить тот,
// который надо (проще в кнопках, отвечающих за смену экрана самому писать 1 лишнюю строчку, таких кнопок всего 3)
{
